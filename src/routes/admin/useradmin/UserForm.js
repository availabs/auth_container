...
import FormComponents from "../../../components/utils/FormComponents.react"
var FormGroup = FormComponents.FormGroup,
...
class PanelBody extends React.Component<void, Props, void> {
    constructor () {
        super();
...
class UserForm extends React.Component<void, Props, void> {
    constructor () {
        super();
